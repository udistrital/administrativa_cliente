...
.controller('SeguimientoycontrolLegalActaAdicionProrrogaCtrl', function ($log, $scope, $routeParams, coreAmazonRequest, administrativaRequest,administrativaWsoRequest,$translate,argoNosqlRequest,agoraRequest,administrativaAmazonRequest) {
    this.awesomeThings = [
        'HTML5 Boilerplate',
        'AngularJS',
        'Karma'
            ...
            {         
                ...
                table: {           
                    ...
                    body:[             
                        ...
                        [ 
                        {text: 'Proyectado'},
                        {text: 'Diana Paola Gutiérrez  Preciado, Abogada Contratista – OAS', alignment: 'justify'},   
                        ' ',
                        ' '        
                        ],   
                        [ 
                        {text: 'Revisado y Aprobado'},
                        {text: 'Carlos Arturo Quintana Astro, Jefe OAS', alignment: 'justify'},         
                        ' ',
                        ' ' 
                        ],          
                    ]         

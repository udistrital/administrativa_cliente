...
angular.module('contractualClienteApp')
  .controller('SeguimientoycontrolLegalActaInicioCtrl', function ($log, $scope, $location, $routeParams, administrativaRequest, $translate, argoNosqlRequest, administrativaWsoRequest, agoraRequest, administrativaAmazonRequest, adminMidRequest)  {
    ...
    */
    // self.formato_generacion_pdf = function(){
    //   argoNosqlRequest.get('plantilladocumento','59d794d4867ee188e42d8b17').then(function(response){
    //     console.log(response.data[0].plantilla);
    //     // var docDefinition = response.data[0].plantilla;
    //     var docDefinition = JSON.stringify(eval("(" + response.data[0].plantilla + ")" ));
    //     var output = JSON.parse(docDefinition);

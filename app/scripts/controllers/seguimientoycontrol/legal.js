...
.controller('SeguimientoycontrolLegalCtrl', function ($log,$location,$scope,administrativaRequest, argoNosqlRequest, administrativaAmazonRequest, coreAmazonRequest, $window,$translate, administrativaWsoRequest, agoraRequest) {
    this.awesomeThings = [
        'HTML5 Boilerplate',
        'AngularJS',
        'Karma'
            ...
            if(wso_response.data.contrato.numero_contrato_suscrito){
                ...
                administrativaWsoRequest.get('contrato_estado', '/'+self.contrato_id+'/'+self.contrato_vigencia).then(function(ce_response){
                    ...
                    administrativaAmazonRequest.get('tipo_contrato', $.param({
                        ...
                        argoNosqlRequest.get('novedad', self.contrato_obj.id + "/" + self.contrato_obj.vigencia + "/" + "59d79683867ee188e42d8c97").then(function(response_nosql){
                            if(response_nosql.data.length > 0){
                                ...
                                swal(
                                    'Información',
                                    'Cesión realizada sobre este contrato!',
                                    'info'
                                );
                            }
